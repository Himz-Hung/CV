...
// Tiếng Việt — toàn bộ nội dung & message của trang bằng tiếng Việt.
export const vi: Translation = {
  ...
  skills: {
    eyebrow: 'Bộ kỹ năng',
    headingLines: ['Công nghệ tôi dùng', 'để tạo ra sản phẩm.'],
  },
  experience: {
    eyebrow: 'Hành trình',
  ...
  projects: {
    eyebrow: 'Tuyển tập dự án',
    headingLines: ['Những sản phẩm', 'tôi đã xây dựng.'],
  },
  contact: {
    eyebrow: 'Cùng làm việc nhé',
    headingLine1: 'Sản phẩm tuyệt vời bắt đầu',
    headingLine2: 'từ một cuộc trò chuyện.',
  ...
  welcome: {
    greeting: 'Xin chào 👋',
    subtitle: 'Chào mừng bạn đến với CV của tôi. Bạn muốn xem bằng ngôn ngữ nào?',
    chooseLanguage: 'Chọn ngôn ngữ',
    vietnamese: 'Tiếng Việt',
    english: 'Tiếng Anh',
    enter: 'Vào xem CV →',
  },
  footer: '© 2026 {name} · Front-end Developer · Thiết kế & xây dựng với React',
